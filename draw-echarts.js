...
function generatePlotByEcharts() {
  var option = {
    title: {
    ...
    xAxis: {
      data: data1 //["shirt", "cardign", "chiffon shirt", "pants", "heels", "socks"]
    },
    yAxis: {},
    series: [{
      name: 'Sales',
      type: 'bar',
      data: chart1opt //[5, 20, 36, 10, 10, 20]
    }]
  };
  chart1 = echarts.init(document.getElementById('scoreChart'));
